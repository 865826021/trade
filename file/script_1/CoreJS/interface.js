	...
	showGuest:function(){
            ...
            if(!objC){
                ...
                if($("#myVideoBox").length<=0){
                    ...
                    var s=Dom.$C("script");
                    s.text="swfobject.embedSWF(\"/file/flash/5ShowShowLivePlayer.swf?roomId="+_show.roomId+"&rtmpHost="+_show.chat+"&cdn="+_show.cdnl+"&keyframe="+_show.zjg+"&height="+_show.height+"&width="+_show.width+"&fps="+_show.fps+"&bandwidth="+_show.zddk+"&quality="+_show.pz+"&rtmpPort=1935&appName=5showcam\", \"JoyShowLivePlayer\", 428,316,\"10.0\", \"\", {},{wmode:\"transparent\",allowscriptaccess:\"always\"});guestflashSwf();JsInterface.guestdrag(\"myVideoBox\",\"dragguest\");";
		...
		if(json && json.code==0){
			...
			function loadFlash(){
				...
				if(_show.emceeId==_show.userId){
					_script.text="swfobject.embedSWF(\"/file/flash/5ShowCamLivePlayer.swf?roomId="+_show.roomId+"&rtmpHost="+_show.chat+"&cdn="+_show.cdn+"&keyframe="+_show.zjg+"&fps="+_show.fps+"&bandwidth="+_show.zddk+"&width="+_show.width+"&height="+_show.height+"&quality="+_show.pz+"&rtmpPort=1935&appName=5showcam\",\"JoyCamLivePlayer\",480,360,\"10.0\", \"\",{},{quality:\"high\",wmode:\"opaque\",allowscriptaccess:\"always\"});"   
				}else{
					_script.text="var showflash = swfobject.embedSWF(\"/file/flash/5ShowShowLivePlayer.swf?roomId="+_show.roomId+"&rtmpHost="+_show.chat+"&cdn="+_show.cdnl+"&keyframe="+_show.zjg+"&fps="+_show.fps+"&bandwidth="+_show.zddk+"&width="+_show.width+"&height="+_show.height+"&quality="+_show.pz+"&rtmpPort=1935&appName=5showcam\",\"JoyShowLivePlayer\", 480,360,\"10.0\", \"\",{},{quality:\"high\",wmode:\"opaque\",allowscriptaccess:\"always\"});"     

var swfobject = function() {
    ...
    function ay(a, c) {
        ...
        if (ak && aS(a)) {
            ...
            az("#" + a, "visibility:" + b+";margin-left:5px;")
        }
    }
    function ai(b) {
        var a = /[\\\"<>\.;]/;
    ...
    function aA(e, g, c) {
        ...
        if (a) {
            ...
            if (ah.ie && ah.win) {
                ...
                a.parentNode.removeChild(a);
                document.write('<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + f + ">" + h + "</object>");
                ag[ag.length] = e.id;
                d = aS(e.id)
            } else {
                var b = ar(aD);

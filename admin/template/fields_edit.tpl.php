...
<tr>
<td class="tl"><span class="f_red">*</span> 前台详情页显示</td>
<td>
<input type="radio" name="post[showpage]" value="1"<?php echo $showpage ? ' checked' : '';?>/> 是
<input type="radio" name="post[showpage]" value="0"<?php echo !$showpage ? ' checked' : '';?>/> 否 <?php tips('如果选择是，则会在前台显示详情页显示此项');?>
</td>
</tr>
</table>

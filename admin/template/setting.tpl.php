...
<tr>
<td class="tl">网站地址</td>
<td><input name="config[url]" type="text" value="<?php echo $url;?>" size="40"/><?php tips('请添写完整URL地址,例如http://www.ds.com/<br/>注意以 / 结尾');?></td>
</tr>
<tr>
...
<td><input name="config[com_domain]" type="text" value="<?php echo $com_domain;?>" size="30"/> <?php tips('如果填写 .ds.com 同时需要将域名泛解析 *.ds.com 指向服务器IP，并且在服务器端绑定泛域名至 网站根目录 或者 网站根目录/company 目录，生成的主页形式为username.ds.com<br/>如果填写 i.ds.com 同时需要将域名泛解析 i.ds.com 指向服务器IP，并且在服务器端绑定域名至网站根目录/company 目录，生成的主页形式为i.ds.com/username/(注：此方式必须支持伪静态)');?></td>
</tr>
<tr>
...
<input type="radio" name="setting[com_www]" value="0"  <?php if(!$com_www){ ?>checked <?php } ?>/> 关闭 <?php tips('例如二级域名为sell.ds.com<br/>添加www后为 www.sell.ds.com');?>
</td>
</tr>
<tr>
...
<td><input name="setting[remote_url]" type="text" value="<?php echo $remote_url;?>" size="60"/><?php tips('例如 http://static.ds.com/，注意以 / 结尾');?></td>
</tr>
<tr> 
...
<tr>
<td class="tl">信任域名</td>
<td><input name="setting[safe_domain]" type="text" value="<?php echo $safe_domain;?>" size="60"/><?php tips('不填写则默认为当前域名<br/>多个域名请用|分开 例如ds.com|ds.cn');?></td>
</tr>
<tr>
...
<td><input name="config[cookie_domain]" type="text" value="<?php echo $cookie_domain;?>" size="20"/><?php tips('例如要保证顶级域名ds.com所有二级域名均可正常登录注销，则填写.ds.com(注意顶级域名前加.)');?></td>
</tr>
<tr>
...
<tr>
<td class="tl">服务帐号</td>
<td><input name="config[cloud_uid]" type="text" id="cloud_uid" value="<?php echo $cloud_uid;?>" size="30"/></td> 
</tr>
<tr>
<td class="tl">服务密钥</td>
...
<div class="tt">直播服务器设置</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl">网站根域名</td>
<td><input name="setting[roodomain]" type="text" id="roodomain" value="<?php echo $roodomain;?>" size="30"/> <?php tips('根域名，如test.com');?></td> 
</tr>
<tr>
<td class="tl">RTMP服务器地址</td>
<td><input name="setting[livecdn]" type="text" id="livecdn" value="<?php echo $livecdn;?>" size="30"/> <?php tips('只填写网址(ip),程序自动组合成推流 格式为：网址(ip)');?></td> 
</tr>
<tr>
<td class="tl">RTMP服务器端口号</td>
<td><input name="setting[livecdnport]" type="text" id="livecdnport" value="<?php echo $livecdnport;?>" size="30"/> <?php tips('只填写端口号,程序自动组合成推流 格式为：端口号');?></td>
</tr>
</table>
<div class="tt">聊天服务器</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl">聊天服务器</td>
<td><input name="setting[nodejs]" type="text" id="nodejs" value="<?php echo $nodejs;?>" size="30"/> <?php tips('聊天服务器格式为：网址(ip)');?></td> 
</tr>
<tr>
<td class="tl">聊天服务器端口</td>
<td><input name="setting[nodejsport]" type="text" id="nodejsport" value="<?php echo $nodejsport;?>" size="30" /> <?php tips('聊天服务器端口号');?></td>
</tr>
</table>
</div>
<script type="text/javascript">
...
<script type="text/javascript" src="http://www.ds.com/sms.php?action=balance&uid=<?php echo DT_CLOUD_UID;?>&key=<?php echo md5(DT_CLOUD_KEY);?>"></script>

...
<?php if($k>6 && $v['vip']==0) { ?><input type="radio" name="member[regid]" value="<?php echo $k;?>" id="g_<?php echo $k;?>"onclick="reg(0);"/><label for="g_<?php echo $k;?>"> <?php echo $GROUP[$k]['groupname'];?></label>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
<?php } } ?>
...
<td class="tr">
<div id="audition"></div>
<input type="radio" name="member[islive]" value="0" id="islive_0"/><label for="islive_0"> 否</label>&nbsp;&nbsp;
<input type="radio" name="member[islive]" value="1" id="islive_1"/><label for="islive_1"> 是</label>&nbsp;&nbsp;
</td>
</tr>

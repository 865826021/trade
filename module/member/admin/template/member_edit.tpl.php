...
<tr>
<td class="tl"><span class="f_hid">*</span> 直播会员</td>
<td class="tr">
<div id="audition"></div>
<input type="radio" name="member[islive]" value="0" <?php if($islive==0) { ?>checked="checked"<?php } ?> id="islive_0"/><label for="islive_0"> 否</label>&nbsp;&nbsp;
<input type="radio" name="member[islive]" value="1" <?php if($islive==1) { ?>checked="checked"<?php } ?> id="islive_1"/><label for="islive_1"> 是</label>&nbsp;&nbsp;
</td>
</tr>
<tr>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 公司类型</td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 主营行业</td>
<td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 主要经营范围</td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 公司成立年份</td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 公司地址</td>
...
<td><input type="text" size="30" name="member[domain]" id="domain" value="<?php echo $domain;?>"/><?php tips('例如 www.ds.com 不带http<br/>同时需要会员将此域名IP指向本站服务器');?></td>
</tr>
<tr>

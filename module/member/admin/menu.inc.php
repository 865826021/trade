...
$menu = array(
	...
	/** 添加直播会员列表 modify by zhang start **/
	array('直播会员', '?moduleid=2&file=live'),	
	/** 添加直播会员列表 modify by zhang end **/
...
$menu_relate = array(
	...
	/** 直播相关 modify by zhang start **/
	array('直播排片', '?moduleid=2&file=live&action=paipian'),
	/** 直播相关 modify by zhang end **/
);

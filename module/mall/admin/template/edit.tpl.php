...
<tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 商品视频ID</td>
<td><input name="post[videoid]" type="text" size="5" value="<?php echo $videoid;?>"/><?php tips('在视频模块中添加视频后可以获取到视频ID<br/>请填写正确的数字ID');?>
</td>
</tr>
<tr>
